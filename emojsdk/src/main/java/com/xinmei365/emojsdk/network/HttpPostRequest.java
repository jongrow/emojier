 ...
 */
public class HttpPostRequest extends HttpReuqest {
    ...
    public HttpPostRequest(String url, String tag, Map<String, String> params, Map<String, String> headers, MediaType mediaType, String content, byte[] bytes, File file) {
